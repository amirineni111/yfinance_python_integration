"""
This script updates the nasdaq_top100 table with industry classification data
It fetches sector, industry, and sub-industry information from Yahoo Finance
Only updates records where sector is NULL or blank
"""
...
print("\n📊 Fetching tickers from nasdaq_top100 table where sector is NULL...")
cursor.execute(f"""
