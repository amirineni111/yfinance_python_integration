"""
This script updates the NSE_500 table with industry classification data - SAMPLE VERSION
It fetches sector, industry, and sub-industry information from Yahoo Finance for first 10 records only
"""
...
# Fetch first 10 tickers where sector is NULL (not yet populated)
print("\n📊 Fetching first 10 tickers from NSE_500 table where sector is NULL...")
cursor.execute(f"""
    SELECT TOP 10 ticker, company_name 
    FROM {table_name} 
