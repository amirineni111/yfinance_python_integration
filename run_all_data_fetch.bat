...
echo.
echo [0/4] Fetching market context data (VIX, indices, sector ETFs, treasury)...
python get_market_context_daily.py

echo.
echo [1/4] Fetching NSE 500 historical data...
python get_histdata_nse500_adhoc.py

echo.
echo [2/4] Fetching NASDAQ 100 historical data...
python get_histdata_nasdaq100_adhoc.py

echo.
echo [3/4] Fetching fundamental data...
